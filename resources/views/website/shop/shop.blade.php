                        ...
                        <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                            ...
                            @foreach ($categories as $category)
                                <li class="mb-2"><a class="reset-anchor"
                                        href="{{ route('shop.id', $category->id) }}">{{ $category->name }}</a></li>
                            @endforeach
                        </ul>
                            ...
                            <div id="range">
                                <form action="{{route('product.filter')}}" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <input type="range" id="minproduct" name="minproduct"
                                               min="0" max="1000" value="0">
                                        <label for="minproduct">Min</label>
                                      </div>

                                      <div>
                                        <input type="range" id="maxproduct" name="maxproduct"
                                               min="1000" max="2000" value="1000" step="10">
                                        <label for="maxproduct">Max</label>
                                      </div>
                                    ...
                                    <div class="product text-center">
                                        <div class="mb-3 position-relative">
                                            <div class="badge text-white badge-"></div><a class="d-block"
                                                href="{{route('product.details',$pro->id)}}"><img class="img-fluid w-100"
                                                    src="{{ asset('backend/assets/images/products/' . $pro->image) }}"
                                                    alt="..."></a>
